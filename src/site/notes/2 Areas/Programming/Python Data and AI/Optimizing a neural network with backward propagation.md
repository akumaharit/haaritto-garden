---
{"dg-publish":true,"permalink":"/2-areas/programming/python-data-and-ai/optimizing-a-neural-network-with-backward-propagation/","created":"2023-02-12T22:00:51.370+07:00","updated":"2025-09-02T23:21:30.873+07:00"}
---
...
- Loss Function
	...
	- จะใช้ [[2 Areas/Programming/Python Data and AI/Mean-Squared Error\|Mean-Squared Error]] ก็ได้ (ก็คือ square error แล้วหา mean ของมันทั้งหมดของแต่ละ datapoint) #tounderstand 
	...
	- ในที่นี้เราจะใช้ algorithm ที่ชื่อว่า gradient descent
		...
		- การหา slope ของ**แต่ละ w เทียบ loss** จะต้องใช้ **chain rule (calculus)** -> ให้ tensorflow / keras ทำแทน #tounderstand 
			...
			- Slope of the [[2 Areas/Programming/Python Data and AI/Mean-Squared Error\|Mean-Squared Error]] (loss) function w.r.t value **at the node we feed into** 
